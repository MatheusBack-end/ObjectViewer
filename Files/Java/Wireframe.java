public class Wireframe extends Component
{
    public MaterialFile wireframe_material;
    ...
    public void start()
    {
        ...
        model_renderer.setMaterialFile(wireframe_material);
        myObject.addComponent(model_renderer);
        w_vertex = vertex;
        make(mr.getVertex());
    }
}
